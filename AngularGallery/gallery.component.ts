...
import { configInterface, preloadImageInterface, slidesInterface, storedImageInterface } from './gallery.interface';
...
export class GalleryComponent implements AfterViewInit, OnDestroy {
    ...
    private zoom = {
        active: false,
        touchScreen: ('ontouchstart' in window || (navigator as any).msMaxTouchPoints),
        start: {
            x: 0,
            y: 0,
            distance: 0
